public class BinarySearchTree {
	...
	private class BSTNode { // private class to hold a tree node
		...
		public void inOrderTraversalPrint() {
			// If there is a left sub tree, go down it recursively
			if (this.getLeftChild() != null)
			{
			...
			// If there is a right sub tree, go down it recursively
				if (this.getRightChild() != null)
			{
		...
		public void inOrderTraversal(DLinkedList dl) {
			...
			// Adds the current value of the node the the tail of the doubly linked list
	...
	public DLinkedList<Integer> inOrderTraversal() {
		...
		// If the root node isn't null recursively calls the inOrderTraversal method
		if (rootNode != null)
		{
